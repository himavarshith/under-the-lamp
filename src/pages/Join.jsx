...
export default function Join() {
  return (
    <div className="min-h-screen bg-parchment flex flex-col items-center justify-center px-4 py-8 gap-4">
      {/* Logo */}
      <img
        src="/UTL Main Logo.svg"
        alt="Under the Lamp"
        className="w-96 md:w-[32rem] opacity-90"
      />

      <div className="w-full max-w-md">
        <div className="text-center mb-2">
          <h2 className="font-serif italic text-3xl mb-1 text-carbon">
            Join the Waitlist
          </h2>
          ...
          <p className="text-carbon/40 text-xs mt-1 font-sans leading-relaxed">
